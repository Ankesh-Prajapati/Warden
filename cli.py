...
@click.option("--module", "modules", multiple=True, default=None, help="Modules to run (default: secrets). Repeatable. Options: secrets, dll_hijack, signature, re_exposure")
